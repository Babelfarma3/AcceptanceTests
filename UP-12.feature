Feature: US12 - Como usuario-persona quiero poder realizar los pedidos mediante vía telefónica, para ocasiones en que se me dificulte hacer las compras vía app.
