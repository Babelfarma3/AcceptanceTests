Feature: US09 - Como usuario-persona, quiero saber las farmacias mejor valoradas en mi zona, para acudir a la que brinde un mejor servicio.
    ...
    When el cliente-persona haga clic en el botón "Buscar farmacias"
