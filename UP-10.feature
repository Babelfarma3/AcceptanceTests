Feature: US10 - Como usuario-persona quiero ver las reseñas y valoraciones en la app de la farmacia que vaya a acudir para poder discernir la mejor opción entre las más cercanas.
