Feature: US13 - Como usuario-farmacia, quiero poder actualizar las unidades de productos disponibles en la app, para no tener ningún inconveniente con la logística del inventario.
